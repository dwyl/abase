...
exports.select = function select (tableName, columns) {
  var query = ['SELECT']
    .concat(columns.join(', '))
    .concat('FROM')
    .concat('"' + tableName + '"')
...
exports.insert = function insert (tableName, fields) {
...
exports.update = function update (tableName, fields) {
...
exports.delete = function _delete (tableName, where) {
