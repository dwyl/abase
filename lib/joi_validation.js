...
function createJoiField (configOptions, extraOptions) {
  ...
  return [configOptions, extraOptions].reduce(function (joiField, options) {
    return Object.keys(options).reduce(addCondition(options), joiField)
  }, joiField);
}
